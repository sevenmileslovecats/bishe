			...
			<template >
				...
				<el-form-item class="date" v-if="type!='info'" label="有效期" prop="youxiaoqi" >
					<el-date-picker
						...
						type="date"
						:readonly="ro.youxiaoqi"
						placeholder="有效期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.youxiaoqi" label="有效期" prop="youxiaoqi" >
				...
				<el-form-item class="select" v-if="type!='info'"  label="验收状态" prop="yanshouzhuangtai" >
					<el-select :disabled="ro.yanshouzhuangtai" v-model="ruleForm.yanshouzhuangtai" placeholder="请选择验收状态"  filterable>
						<el-option
				...
				<el-form-item v-else class="input" label="验收状态" prop="yanshouzhuangtai" >
					<el-input v-model="ruleForm.yanshouzhuangtai"
						placeholder="验收状态" readonly></el-input>
				</el-form-item>
		...
		methods: {
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.yanshouzhuangtai = '未验收'; 				}

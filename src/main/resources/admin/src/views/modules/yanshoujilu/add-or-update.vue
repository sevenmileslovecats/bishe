	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="验收结果" prop="yanshoujieguo" >
					<el-select :disabled="ro.yanshoujieguo" v-model="ruleForm.yanshoujieguo" placeholder="请选择验收结果"  filterable>
						<el-option
				...
				<el-form-item v-else class="input" label="验收结果" prop="yanshoujieguo" >
					<el-input v-model="ruleForm.yanshoujieguo"
						placeholder="验收结果" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="验收记录" prop="yanshoujilu" >
					<el-input v-model="ruleForm.yanshoujilu" placeholder="验收记录" clearable  :readonly="ro.yanshoujilu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="验收记录" prop="yanshoujilu" >
					<el-input v-model="ruleForm.yanshoujilu" placeholder="验收记录" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="验收人" prop="yanshouren" >
					<el-input v-model="ruleForm.yanshouren" placeholder="验收人" clearable  :readonly="ro.yanshouren"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="验收人" prop="yanshouren" >
					<el-input v-model="ruleForm.yanshouren" placeholder="验收人" readonly></el-input>
				</el-form-item>
				<el-form-item class="date" v-if="type!='info'" label="验收时间" prop="yanshoushijian" >
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.yanshoushijian" 
						type="datetime"
						:readonly="ro.yanshoushijian"
						placeholder="验收时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.yanshoushijian" label="验收时间" prop="yanshoushijian" >
					<el-input v-model="ruleForm.yanshoushijian" placeholder="验收时间" readonly></el-input>
				</el-form-item>
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							if(this.type=='cross' && !this.ruleForm.id) {
								await this.$http({
									url: `yanshoujilu/accept`,
									method: "post",
									data: {
										juanzengwuziId: objcross.id,
									...
									if (data && data.code === 0) {
										this.$message({
											...
											onClose: () => {
												...
												this.parent.yanshoujiluCrossAddOrUpdateFlag = false;
												this.parent.search();
											}
										});
									} else {
							...
							await this.$http({
								url: `yanshoujilu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {

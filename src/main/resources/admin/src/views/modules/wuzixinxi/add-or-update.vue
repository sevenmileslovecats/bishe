		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="物资种类" prop="wuzizhonglei" >
					<el-select :disabled="ro.wuzizhonglei" v-model="ruleForm.wuzizhonglei" placeholder="请选择物资种类"  filterable>
						<el-option
				...
				<el-form-item class="date" v-if="type!='info'" label="保质期" prop="baozhiqi" >
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.baozhiqi" 
						type="date"
						:readonly="ro.baozhiqi"
						placeholder="保质期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.baozhiqi" label="保质期" prop="baozhiqi" >
					<el-input v-model="ruleForm.baozhiqi" placeholder="保质期" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="存储位置" prop="cunchuweizhi" >
					<el-input v-model="ruleForm.cunchuweizhi" placeholder="存储位置" clearable  :readonly="ro.cunchuweizhi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="存储位置" prop="cunchuweizhi" >
					<el-input v-model="ruleForm.cunchuweizhi" placeholder="存储位置" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="物资详情" prop="wuzixiangqing" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.wuzixiangqing" label="物资详情" prop="wuzixiangqing"  class="textBox">
				<span class="text">{{ruleForm.wuzixiangqing}}</span>
			</el-form-item>
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='cunchuweizhi'){
							this.ruleForm.cunchuweizhi = obj[o];
							this.ro.cunchuweizhi = true;
							continue;
						}
					}
				}

<template>
	<div :style='{"padding":"30px"}'>
		<el-form
			v-if="showType==1"
			:style='{"padding":"50px 20% 50px 10%","boxShadow":"none","borderColor":"#ff9164","borderRadius":"10px","flexWrap":"wrap","background":"#fff8f0","borderWidth":"4px 0 0 0","display":"flex","borderStyle":"solid"}'
		...
		>
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"10px auto 0","justifyContent":"center","display":"flex"}'>
				<el-button class="btn3" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#2f6a38","width":"auto","fontSize":"16px","height":"40px"}' type="primary" @click="onUpdateHandler">
		...
		async onUpdateHandler() {
			this.$refs["ruleForm"].validate(async valid => {
				if (valid) {
					...
					if (this.$storage.get("sessionTable") == 'jieshoujigou') {
					}
					if (this.ruleForm.password != password) {
						this.$message.error("原密码错误");
						return;

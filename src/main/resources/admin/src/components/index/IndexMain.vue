<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 100px","margin":"0","position":"relative","background":"#f9f7f3","display":"block"} : {"minHeight":"100%","padding":"60px 0 30px 210px","margin":"0","position":"relative","background":"#f9f7f3","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 0px #e7e8fc","padding":"0px 20px","alignItems":"center","color":"#fff","display":"flex","justifyContent":"center","top":"0","left":"0","background":"#ff9264","width":"100%","position":"fixed","zIndex":"1","height":"60px"}'></index-header>
			...
			<template v-if="'vertical' == 'vertical'">
			  ...
			  <template v-if="2 == 2">
				<index-aside :is-collapse="isCollapse" @oncollapsechange="collapseChange" :style='isCollapse ? {"boxShadow":"1px 0 0px  #e7e8fc","overflow":"hidden","top":"0px","left":"0","background":"#304156","bottom":"0","width":"100px","position":"fixed","transition":"width 0.3s","height":"100%","zIndex":"1001"} : {"boxShadow":"1px 0 0px  #ddd","overflow":"hidden","top":"0","left":"0","background":"#304156","bottom":"0","width":"210px","position":"fixed","transition":"width 0.3s","height":"100%","zIndex":"1001"}'></index-aside>
			  </template>
			</template>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"15px 10px","margin":"15px auto 0 auto","borderColor":"#e7e8fc","borderRadius":"6px","borderWidth":"0px","background":"none","width":"calc(100% - 60px)","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>

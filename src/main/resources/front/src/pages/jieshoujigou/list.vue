		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item" >
					...
					<el-input v-model="formSearch.jigouzhanghao" placeholder="机构账号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item" >
					<div class="lable">机构名称：</div>
					<el-input v-model="formSearch.jigoumingcheng" placeholder="机构名称" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('jieshoujigou','新增')" type="primary" @click="add('/index/jieshoujigouAdd')">
			...
			<div class="list">
				<div class="list5">
					<div v-for="(item,index) in dataList" :key="index" class="list-item" @click.stop="toDetail(item)" >
						...
						<div class="infoBox">
							<div class="name">{{item.jigoumingcheng}}</div>
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.jigouzhanghao != ''&&this.formSearch.jigouzhanghao != undefined) searchWhere.jigouzhanghao = '%' + this.formSearch.jigouzhanghao + '%';
				if (this.formSearch.jigoumingcheng != ''&&this.formSearch.jigoumingcheng != undefined) searchWhere.jigoumingcheng = '%' + this.formSearch.jigoumingcheng + '%';
				if(!this.centerType){
					params['sfsh'] = '是';
				}
				...
				this.$http.get(`jieshoujigou/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/jieshoujigouDetail', query: params});
			},

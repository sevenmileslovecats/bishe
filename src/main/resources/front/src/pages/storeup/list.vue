<template>
	<div :style='{"alignContent":"flex-start","padding":"0 7%","margin":"0px auto","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative"}'>
		<div class="back_box">
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 0 50px","borderColor":"#e61f4d","margin":"10px auto","color":"#333","textAlign":"left","display":"block","background":"url(http://codegen.caihongy.cn/20250906/f30f666cf13e4b9eba21c610c210dcd4.png) no-repeat left center / 40px 100%","borderWidth":"0 0 0px","width":"100%","lineHeight":"40px","fontSize":"32px","borderStyle":"solid","fontWeight":"600"}'>我的收藏</div>
		<div v-if="storeupType==81" class="section-title" :style='{"padding":"0 0 0 50px","borderColor":"#e61f4d","margin":"10px auto","color":"#333","textAlign":"left","display":"block","background":"url(http://codegen.caihongy.cn/20250906/f30f666cf13e4b9eba21c610c210dcd4.png) no-repeat left center / 40px 100%","borderWidth":"0 0 0px","width":"100%","lineHeight":"40px","fontSize":"32px","borderStyle":"solid","fontWeight":"600"}'>我的评论</div>

					...
					<el-table-column :resizable='true' prop="qianshoutupian" width="200" label="签收图片">
						<template slot-scope="scope">
							<div v-if="scope.row.qianshoutupian">
								...
								<img v-else :src="baseUrl+scope.row.qianshoutupian.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(baseUrl+scope.row.qianshoutupian.split(',')[0])">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
